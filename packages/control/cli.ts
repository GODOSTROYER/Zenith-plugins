...
export async function main(args:string[]=process.argv.slice(2),options:ControlMainOptions={}):Promise<void>{
  ...
  if(command==='stdio'){await serveControl(new ClientResolver(),activation);return;}
